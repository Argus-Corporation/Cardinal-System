...
public class CQLTest {
	...
	public static void main(String[] args) throws IOException {
		...
		String savedBase = "data:DataTest@{table:empty@map@[{column:id@INT}={0, 1, 2}, {column:username@STRING}={'django', 'harry potter', 'océane '}]}, {table:profile@map@[{column:first-name@STRING}={}, {column:last-name@STRING}={}]}";
		/*System.out.println(
