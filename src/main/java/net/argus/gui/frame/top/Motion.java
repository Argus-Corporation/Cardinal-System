	...
	private MouseMotionListener getMouseMotionListener() {
		return new MouseMotionListener() {
			...
			public void mouseDragged(MouseEvent e) {
				...
				if(titleBar.getFrame().isResizable())
					if(titleBar.getFrame().isMaximized() && y > 0)
	...
	private MouseListener getMouseListener() {
		return new MouseListener() {
			public void mouseReleased(MouseEvent e) {
				...
				if(titleBar.getFrame().isResizable() && !titleBar.getFrame().isMaximized() && getY(titleBar.getFrame().getLocation().y) <= 0)
			...
			public void mouseClicked(MouseEvent e) {
				if(titleBar.getFrame().isResizable() && e.getButton() == MouseEvent.BUTTON1 && e.getClickCount() == 2)
